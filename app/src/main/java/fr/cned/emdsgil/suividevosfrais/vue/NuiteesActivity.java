...
public class NuiteesActivity extends AppCompatActivity {
    ...
    private final static String TYPE_FRAIS = "nuitees";
    ...
    private void retourActivityPrincipale() {
        Intent intent = new Intent(NuiteesActivity.this, AccueilActivity.class);
    ...
    private void cmdValider_clic() {
        findViewById(R.id.cmdNuiteesValider).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                controleur.serialize(NuiteesActivity.this);
                retourActivityPrincipale();
            }
        });
    }
